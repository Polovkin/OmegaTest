  ...
  #app
          ...
          .registration__item.registration__item--wraped
            label.registration__item-label(for='name')
              ...
              span.error(v-if="($v.surname.$dirty && !$v.surname.required)")
                | The Surname field must not be empty
              span.error(v-else-if="($v.surname.$dirty && !$v.surname.minLength)")
                | Surname must be at least {{$v.surname.$params.minLength.min}} characters.
              span.error(v-else-if="($v.surname.$dirty && !$v.surname.maxLength)")
                | Surname should be no more than {{$v.surname.$params.maxLength.min}} characters.
        .registration__item
    ...
    template(v-else)
      .registration__success
         img(src="/assets/img/icons/seccess.svg")
         p Thank you!
</template>
